            ...
            <div class="col-md-12 col-lg-6 col-xl-4">
                <div class="card m-b-30">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-7">
                                <h5 class="card-title mb-0">Today Sell</h5>
                            </div>
                            <div class="col-5">
                    ...
                    <div class="card-body text-center pb-0 px-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-4"><h3>{{ \App\Invoice::whereDate('created_at', \Carbon\Carbon::today())->sum('total_price') }}৳</h3></div>
                            <div class="col-md-4"><p><span class="badge badge-success-inverse font-16">
                                        {{ (\App\Invoice::whereDate('created_at', \Carbon\Carbon::today())->sum('total_price'))
                                         -
                                         (\App\Item::whereDate('updated_at', \Carbon\Carbon::today())->sum('buy_price')
                                          *
                                           (\App\Sale::whereDate('created_at', \Carbon\Carbon::today())->sum('quantity')))}}
                                        ৳<i class="feather icon-arrow-up-right"></i></span></p></div>
                        </div>
